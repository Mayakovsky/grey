// grey-pipeline — Type Definitions (verification-pipeline subset).
// Ported from plugin-wpv/src/types.ts. ElizaOS/ACP/discovery glue dropped;
// only the types the verification pipeline stages exchange are kept.
