// Bankr x402 Cloud handler for the "verify-full-tech" service (bankr.x402.json). Plain
...
export default async function handler(req: Request) {
  ...
  const res = await fetch(
    process.env.GREY_BRIDGE_URL ?? "https://api.whitepapergrey.com/v1/bridge/bankr/verify_full_tech",
    {
      method: "POST",
      headers: {
